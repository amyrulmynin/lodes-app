...
const mainMenu = [
  ...
  { href: "/admin/cash-flow", label: "Duit Masuk/Keluar", icon: ArrowLeftRight },
...
const manageMenu = [
  ...
  { href: "/admin/purchases", label: "Belian Barang", icon: ShoppingBag },
  { href: "/admin/supplier-orders", label: "Supplier Orders", icon: Package },
  { href: "/admin/salary", label: "Gaji Founder", icon: Banknote },
